# TASK-0022: CloudWatch Alarms + Chatbot 設定 ✅ **完了** (TDD開発完了 - 46テストケース全通過)
...
- [x] ECS CPU Utilization Alarm が作成される (閾値: 80%)
- [x] ECS Memory Utilization Alarm が作成される (閾値: 80%)
- [x] CloudWatch Logs Error Pattern Alarm が作成される
- [x] SNS Topic が作成される
- [x] AWS Chatbot が Slack と連携される
- [x] アラーム発生時に Slack 通知が送信される
- [x] 全てのユニットテストが通過する
