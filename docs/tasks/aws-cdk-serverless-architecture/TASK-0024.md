...
- [x] Ops Stack が作成される
- [x] CloudWatch Logs Construct が Stack に統合される
- [x] CloudWatch Alarms Construct が Stack に統合される
- [x] AWS Chatbot Construct が Stack に統合される
- [x] CI/CD Pipeline Construct が Stack に統合される
- [x] 全 6 Stack の統合テストが通過する
- [x] Dev 環境設定が正しく適用される
- [x] Prod 環境設定が正しく適用される
- [x] CDK Synth が成功する
- [x] 全てのユニットテストが通過する
...
- [x] 6 Stack 構成 (VPC, Security, Database, Application, Distribution, Ops)
- [x] Stack 間依存関係が設計通り
- [x] 各 Stack の責務が明確に分離
...
- [x] IAM ロールの最小権限原則
- [x] 暗号化設定 (KMS, S3, Aurora)
- [x] Security Group の適切な設定
